...
namespace Registros.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpleadosID,Nombre,Cedula,Telefono,Direccion,FechaNacimiento,FechaDeEntrada,SueldoFijo,Email")] Empleados empleados)
        {
            if (ModelState.IsValid)
            {
